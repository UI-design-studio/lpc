import { i as normalizeBaseNames, n as getScreenshotName, r as getMetadataPath, t as validateThreshold } from "./threshold-CTtyBFha.mjs";
...
//#region src/fs.ts
const createDirectoryPromises = /* @__PURE__ */ new Map();
/**
...
async function createTemporaryDirectory() {
	const path = join(tmpdir(), "argos." + randomBytes(16).toString("hex"));
...
function readVersionFromPackage(pkgPath) {
	...
	if (!versionCache.has(pkgPath)) versionCache.set(pkgPath, readVersion());
	const fromCache = versionCache.get(pkgPath);
	if (!fromCache) throw new Error("Invariant violation: version not in cache");
	return fromCache;
}
//#endregion
//#region src/metadata-io.ts
/**
...
//#endregion
//#region src/playwright-trace.ts
/**
...
//#endregion
export { createDirectory, createTemporaryDirectory, getGitRepositoryPath, getMetadataPath, getPlaywrightTracePath, getScreenshotName, normalizeBaseNames, readMetadata, readVersionFromPackage, validateThreshold, writeMetadata };
