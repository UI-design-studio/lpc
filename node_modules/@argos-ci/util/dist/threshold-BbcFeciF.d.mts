...
type ScreenshotMetadata = {
  ...
  transient?: {
    /** Threshold configured for this screenshot. */threshold?: number;
    /**
     ...
     * the baseline wins.
     */
    baseName?: string | string[]; /** Name of the parent screenshot. */
    parentName?: string;
  };
};
/**
 ...
 */
declare function normalizeBaseNames(baseName: string | string[] | undefined | null): string[] | null;
//#endregion
...
//#endregion
export { getMetadataPath as a, ScreenshotMetadata as i, getScreenshotName as n, normalizeBaseNames as r, validateThreshold as t };