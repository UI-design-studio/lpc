...
__export(src_exports, {
    DynamicPublicDirectory: function() {
    ...
    resolveInternalConfig: function() {
        return resolveInternalConfig;
    }
});
...
function _checkIsFolder() {
    _checkIsFolder = _async_to_generator(function(pathToCheck) {
        ...
        return _ts_generator(this, function(_state) {
            ...
            return [
                2,
                import_fs.default.promises.stat(pathToCheck).then(function(stats) {
                    if (stats.isFile()) {
                        isFolder = false;
                    }
        ...
        return _ts_generator(this, function(_state) {
            switch(_state.label){
                case 0:
                    ...
                    return [
                        4,
                        import_fs2.default.promises.lstat(source)
                    ];
                case 1:
                    stat = _state.sent();
                    ...
                    return [
                        4,
                        import_fs2.default.promises.readlink(source)
                    ];
                case 2:
                    realPath = _state.sent();
                    absoluteRealPath = (0, import_path.resolve)((0, import_path.dirname)(source), realPath);
                    return [
                        4,
                ...
                case 4:
                    ...
                    return [
                        4,
                        import_fs2.default.promises.mkdir(destination, {
                            recursive: true
                        })
                    ];
                case 5:
                    ...
                    return [
                        4,
                        import_fs2.default.promises.readdir(source)
                    ];
                case 6:
                    items = _state.sent();
                ...
                case 8:
                    ...
                    return [
                        4,
                        copyWithResolvedSymlinks(replacePosixSep((0, import_path.join)(source, item)), replacePosixSep((0, import_path.join)(destination, item)))
                    ];
                case 9:
                    _state.sent();
                    _state.label = 10;
                ...
                case 15:
                    return [
                        4,
                        import_fs2.default.promises.copyFile(source, destination)
                    ];
                case 16:
                    _state.sent();
                    _state.label = 17;
...
function replacePosixSep(value) {
    return value.replaceAll(import_path.sep, import_posix.sep);
}
var checkSymLink = function(path) {
    try {
        return import_fs2.default.lstatSync(path).isSymbolicLink();
    } catch (error) {
        return false;
    }
};
function readSymlink(path, cb) {
    import_fs2.default.readlink(path, function(err, linkString) {
    ...
    if (/\.(css|scss|sass|less|styl|stylus)$/.test(id)) {
        return {
            code: code.replace(/url\(["']?([^"')]+)["']?\)/g, function(match, url) {
                if (!import_micromatch.default.isMatch(url, "".concat(viteBase2, "**")) && mapper2.mapper[replaceStartCharacter(url, "/")]) {
                    return match.replace(url, replacePosixSep((0, import_path2.join)(viteBase2, url)));
                }
                return match;
            })
        };
    ...
    var resolve4 = function(_param) {
        ...
        try {
            for(var _iterator = files[Symbol.iterator](), _step; !(_iteratorNormalCompletion = (_step = _iterator.next()).done); _iteratorNormalCompletion = true){
                ...
                if (!(asset in list)) {
                    var scan = import_micromatch2.default.scan(asset);
                    list[asset] = {
                        base: scan.base,
                        glob: scan.glob,
                        startGlob: scan.input.indexOf(scan.glob),
                        isMatch: import_micromatch2.default.matcher(asset, _object_spread({
                            ignore: ignore
                        }, opts))
                    };
                }
        ...
        for(var _iterator = data[Symbol.iterator](), _step; !(_iteratorNormalCompletion = (_step = _iterator.next()).done); _iteratorNormalCompletion = true){
            ...
            if (typeof item === "string") {
                ...
                if (watch) {
                    ...
                    path && watchPaths.push((0, import_path3.resolve)(cwd, path));
                }
                __files.push(input);
                __data.push(item);
            }
...
function handleWatchPath(path) {
    return import_fast_glob.default.sync(path.replace("**", ""), {
        onlyFiles: false,
        ...
        return _ts_generator(this, function(_state) {
            switch(_state.label){
                case 0:
                    ...
                    return [
                        4,
                        import_fast_glob.default.glob(__transformFiles, _object_spread_props(_object_spread({
                            // onlyFiles: false,
                            ignore: [],
                            onlyFiles: true,
                    ...
                    try {
                        _loop = function() {
                            ...
                            var indexMatch = data.findIndex(function(item) {
                                return import_micromatch2.default.isMatch(filepath, item.input);
                            });
                            ...
                            name = output ? replacePosixSep((0, import_path3.join)(replaceOutput, flatten ? (0, import_path3.basename)(filepath) : _dstFile)) : _dstFile;
                            ...
                            mapper2[name] = {
                                path: (0, import_path3.resolve)(opts.cwd, filepath),
                                output: (0, import_path3.dirname)(name),
                                isSymLink: opts.followSymbolicLinks ? checkSymLink(filepath) : false,
                                root: countParent ? (0, import_path3.resolve)(opts.cwd, joinPath) : ""
                            };
                        };
                        ...
                        return _ts_generator(this, function(_state) {
                            switch(_state.label){
                                case 0:
                                    ...
                                    dstFile = (0, import_path3.isAbsolute)(_dstFile) ? _dstFile : replacePosixSep((0, import_path3.join)(opts.__dst, output || _dstFile));
                                    pathDst = output ? replacePosixSep((0, import_path3.join)(dstFile, (0, import_path3.basename)(path))) : dstFile;
                                    dirnamePathDst = (0, import_path3.dirname)(pathDst);
                                    return [
                                        4,
                                        import_fs3.default.promises.mkdir(dirnamePathDst, {
                                            recursive: true
                                            ...
                                            return _ts_generator(this, function(_state) {
                                                switch(_state.label){
                                                    ...
                                                    case 1:
                                                        ...
                                                        return [
                                                            2,
                                                            !check ? import_fs3.default.promises.copyFile(path, pathDst) : null
                                                        ];
                                                }
                                            });
                                                ...
                                                return _ts_generator(this, function(_state) {
                                                    switch(_state.label){
                                                        case 0:
                                                            ...
                                                            return [
                                                                4,
                                                                import_fs3.default.promises.mkdir(dstFile)
                                                            ];
                                                        case 1:
                                                            return [
                                                                2,
                                                                        ...
                                                                        return _ts_generator(this, function(_state) {
                                                                            switch(_state.label){
                                                                                ...
                                                                                case 1:
                                                                                    return [
                                                                                        4,
                                                                                        copyWithResolvedSymlinks((0, import_path3.resolve)(root, linkString), pathDst)
                                                                                    ];
                                                                                case 2:
                                                                                    _state.sent();
                                                                                    _state.label = 3;
...
// src/server.ts
var import_watchpack = __toESM(require("watchpack"));
...
function parseRange(rangeHeader, fileSize) {
    ...
    var start = match[1] ? Number.parseInt(match[1], 10) : 0;
    var end = match[2] ? Number.parseInt(match[2], 10) : fileSize - 1;
...
function handleWriteToServe(res, req, contentType, path) {
    ...
    try {
        var stats = import_fs4.default.statSync(path);
        ...
        if (range) {
            ...
            var fileStream = import_fs4.default.createReadStream(path, {
                start: start,
                end: end
            });
            fileStream.pipe(res);
            ...
            var fileStream1 = import_fs4.default.createReadStream(path);
...
var wp = new import_watchpack.default({
                                    ...
                                    return _ts_generator(this, function(_state) {
                                        ...
                                        if (file === null || file === void 0 ? void 0 : file.isSymLink) {
                                            readSymlink(path, function(err, linkString) {
                                                if (!err) {
                                                    path = (0, import_path4.resolve)(file.root, linkString);
...
function resolveInternalConfig(param) {
    ...
    if (viteConfig || force === "vite" || force === true) {
        ...
        (_opts_cwd = opts.cwd) !== null && _opts_cwd !== void 0 ? _opts_cwd : opts.cwd = (_viteConfig_root = viteConfig === null || viteConfig === void 0 ? void 0 : viteConfig.root) !== null && _viteConfig_root !== void 0 ? _viteConfig_root : force ? process.cwd() : void 0;
    }
}
function DynamicPublicDirectory(assets) {
    ...
    return {
        ...
        writeBundle: function writeBundle(writeBundleOptions) {
            return _async_to_generator(function() {
                return _ts_generator(this, function(_state) {
                    switch(_state.label){
                        case 0:
        ...
        transform: /*#__PURE__*/ function() {
            var _ref = _async_to_generator(function(code, id) {
                return _ts_generator(this, function(_state) {
                    switch(_state.label){
                        case 0:
                            ...
                            return [
                                4,
                                getFiles(assets, opts, viteConfig)
                            ];
                        case 1:
                            mapper = _state.sent();
                            _state.label = 2;
...
0 && (module.exports = {
    DynamicPublicDirectory: DynamicPublicDirectory,
    ServerMiddleWare: ServerMiddleWare,
    astroMultipleAssets: astroMultipleAssets,
    resolveInternalConfig: resolveInternalConfig
});
